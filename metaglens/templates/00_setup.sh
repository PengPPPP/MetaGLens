...
#SBATCH --output={{WORK_DIR}}/metaglens_results/reports/logs/00_setup_%j.log
...
init_status_file() {
    ...
    METAGLENS_RAW_DATA_DIR="${RAW_DATA_DIR}" \
...
data = {
    ...
    "raw_data_dir": os.environ["METAGLENS_RAW_DATA_DIR"],
