...
def showcase(
    ...
    audience: str = typer.Option("judge", "--audience",
                                 help="Copy variant: 'judge' (competition story) or 'user' (no AI mentions)."),
) -> None:
    ...
    if export:
        ...
        out = export_static(export, route=route, audience=audience)
